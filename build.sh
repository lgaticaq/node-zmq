docker build -t node-zmq:7.3.0 7.3.0
docker tag node-zmq:7.3.0 lgatica/node-zmq
docker tag node-zmq:7.3.0 lgatica/node-zmq:7.3.0
docker tag node-zmq:7.3.0 lgatica/node-zmq:7.3
docker tag node-zmq:7.3.0 lgatica/node-zmq:7
docker tag node-zmq:7.3.0 lgatica/node-zmq:latest
...
docker build -t node-zmq:7.3.0-onbuild 7.3.0/onbuild
docker tag node-zmq:7.3.0-onbuild lgatica/node-zmq:7.3.0-onbuild
docker tag node-zmq:7.3.0-onbuild lgatica/node-zmq:7.3-onbuild
docker tag node-zmq:7.3.0-onbuild lgatica/node-zmq:7-onbuild
docker tag node-zmq:7.3.0-onbuild lgatica/node-zmq:onbuild
...
docker build -t node-zmq:7.3.0-yarn 7.3.0/yarn
docker tag node-zmq:7.3.0-yarn lgatica/node-zmq:7.3.0-yarn
docker tag node-zmq:7.3.0-yarn lgatica/node-zmq:7.3-yarn
docker tag node-zmq:7.3.0-yarn lgatica/node-zmq:7-yarn
docker tag node-zmq:7.3.0-yarn lgatica/node-zmq:yarn
