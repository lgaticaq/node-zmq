...
- 8.9.0, 8.9, 8, latest ([8.9/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.9.0/Dockerfile))
- 8.9.0-onbuild, 8.9-onbuild, 8-onbuild, onbuild ([8.9/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.9.0/onbuild/Dockerfile))
