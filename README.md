...
- 8.8.0, 8.8, 8, latest ([8.8/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.8.0/Dockerfile))
- 8.8.0-onbuild, 8.8-onbuild, 8-onbuild, onbuild ([8.8/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.8.0/onbuild/Dockerfile))
