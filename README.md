...
- 8.8.1, 8.8, 8, latest ([8.8/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.8.1/Dockerfile))
- 8.8.1-onbuild, 8.8-onbuild, 8-onbuild, onbuild ([8.8/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.8.1/onbuild/Dockerfile))
