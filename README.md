...
- 8.1.0, 8.1, 8, latest ([8.1/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.1.0/Dockerfile))
- 8.1.0-onbuild, 8.1-onbuild, 8-onbuild, onbuild ([8.1/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.1.0/onbuild/Dockerfile))
