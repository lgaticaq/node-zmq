...
- 7.7.4, 7.7, 7, latest ([7.7/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/7.7.4/Dockerfile))
- 7.7.4-onbuild, 7.7-onbuild, 7-onbuild, onbuild ([7.7/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/7.7.4/onbuild/Dockerfile))
- 6.10.1, 6.10, 6 ([6.10/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/6.10.1/Dockerfile))
- 6.10.1-onbuild, 6.10-onbuild, 6-onbuild ([6.10/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/6.10.1/onbuild/Dockerfile))
