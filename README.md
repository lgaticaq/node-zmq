...
- 8.2.0, 8.2, 8, latest ([8.2/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.2.0/Dockerfile))
- 8.2.0-onbuild, 8.2-onbuild, 8-onbuild, onbuild ([8.2/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/8.2.0/onbuild/Dockerfile))
- 6.11.3, 6.11, 6 ([6.11/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/6.11.3/Dockerfile))
- 6.11.3-onbuild, 6.11-onbuild, 6-onbuild ([6.11/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/6.11.3/onbuild/Dockerfile))
