...
- 7.7.3, 7.7, 7, latest ([7.7/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/7.7.3/Dockerfile))
- 7.7.3-onbuild, 7.7-onbuild, 7-onbuild, onbuild ([7.7/onbuild/Dockerfile](https://github.com/lgaticaq/node-zmq/blob/master/7.7.3/onbuild/Dockerfile))
